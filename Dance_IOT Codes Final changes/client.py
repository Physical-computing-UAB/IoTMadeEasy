...
#func_object = functions.functions()
...
class Client(object):
    ...
    * Use disconnect() to disconnect from the broker
    ...
    def loop(self, timeout=1.0, max_packets=1):
        ...
        txt_file = open("/Users/plorente/Downloads/bioRAK/rent.json","a")
        txt_file.write(str(temp).replace("'","")+",")
        txt_file.close()
        func_object2.printColours(temp,"/Users/plorente/Downloads/bioRAK/rent2.txt")
        print("temp is ",temp)
        # file2 = open("C:/Users/Rakshit/Downloads/rent.txt","a")
        # str1=""
        # str2=""
        # for b in temp:
        ...
        #         j+=1
        #     y=str2.split(" ")
        #     func_object.printColours(params)
        #     # sum1=float(y[0])+float(y[1])+float(y[2])
        #     # sum2=float(y[3])+float(y[4])+float(y[5])
        #     # sum3=float(y[6])+float(y[7])+float(y[8])
        ...
        # string1 = str(temp).replace("[","{")
        # string1 = string1.replace("]","}")
        # dict = ast.literal_eval(string1)
        # print(dict) 
        # df = pd.DataFrame(dict)
        # with open('C:/Users/Rakshit/Downloads/my13.csv','a') as f:
        ...
        # js = json.dumps(temp)
        # js2 = ""
        # for s in range(len(js)-1):
        #     if(js[s]==']' and js[s+1]=='['):
        #         js2=js2+"],"
        #     else:
        #         js2=js2+js[s]
        # js2 = js2 + js[len(js)-1]
        # out_file = open(r'C:/Users/Rakshit/Downloads/my11k.json', 'a')
        # df = pd.DataFrame(temp, columns=['data'])
        # df.to_csv('lista.csv', index=False)
        # json.dump(temp,out_file)
        # out_file.close()
        # with open(r'C:/Users/Rakshit/Downloads/my9.json','r') as f:
        #     data = f.read()
        # data = "[" + data.replace("][","],[",data.count("][")) + "]"
        # json_data = json.loads(data)
        # with open(r'C:/Users/Rakshit/Downloads/my9.json','w') as outfile:
